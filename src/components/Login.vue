  ...
  >
    <div class="wrapper">
      <div class="title-text">
        <div class="title login" :class="{ active: isLoginActive }">
          Login Form
        </div>
        <div class="title signup" :class="{ active: !isLoginActive }">
          Signup Form
        </div>
      </div>
      <div class="form-container">
        <div class="slide-controls">
          ...
          <input
            ...
            :value="false"
          />
          <label for="login" class="slide login" @click="setLoginActive(true)"
            >Login</label
          >
          <label
            for="signup"
            class="slide signup"
            @click="setLoginActive(false)"
            >Signup</label
          >
          <div
            class="slider-tab"
